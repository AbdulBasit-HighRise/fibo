...
const ContactSticker = () => {
  ...
  {isOpen && (
    <div className="w-[320px] -translate-x-5 bg-zinc-950/90 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden">
      {/* Form Header */}
    ...
    >
      <div className="bg-zinc-950/80 backdrop-blur-2xl border border-white/10 p-3 rounded-l-2xl shadow-2xl flex flex-col items-center gap-6 group-hover:border-blue-500/50 transition-colors duration-300">
        <div className="relative flex h-2 w-2">
          {/* Sirf yeh blue signal dot alert ke liye animate karega jo standard CSS hai */}
