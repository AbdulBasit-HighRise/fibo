    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 2xl:gap-16 items-center">
      ...
      <div className="lg:col-span-7 text-center lg:text-left flex flex-col items-center lg:items-start">
        <h1 className="text-[1.9rem] sm:text-[3.5rem] md:text-[4rem] lg:text-[3.8rem] 2xl:text-[5.5rem] font-black leading-[1.1] lg:leading-[1.05] tracking-tighter text-white max-w-2xl lg:max-w-none">
          Driving Modern <br className="hidden lg:block" /> Digital Excellence.
        </h1>

        <div className="mt-6 space-y-4">
          <p className="text-white/90 text-[16px] md:text-base lg:text-[17px] 2xl:text-xl 3xl:text-2xl font-medium leading-relaxed max-w-xl 2xl:max-w-2xl mx-auto lg:mx-0">
            Defining the Digital Frontier — from Web & Apps to Blockchain & AI.
          </p>
          <p className="text-white font-bold text-[16px] md:text-base lg:text-[17px] 2xl:text-xl 3xl:text-2xl leading-relaxed max-w-xl 2xl:max-w-2xl mx-auto lg:mx-0">
            AGI Innovations: Transforming Bold Ambitions into Future-Ready Reality.
          </p>
        </div>
