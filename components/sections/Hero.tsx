...
export default function HeroSection() {
  return (
   <section className="relative min-h-fit lg:min-h-[70vh] 2xl:min-h-[65vh] 3xl:min-h-[60vh] bg-[#222630] overflow-hidden flex items-center 
  selection:bg-white selection:text-black py-20 md:py-24 lg:py-28 2xl:py-36 3xl:py-48">
    ...
    <div className="relative z-[3] max-w-7xl 2xl:max-w-[110rem] mx-auto px-6 w-full">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 2xl:gap-16 items-center">
        ...
        <div className="lg:col-span-7 text-center lg:text-left flex flex-col items-center lg:items-start">
          <h1 className="text-[1.9rem] sm:text-[3.5rem] md:text-[3rem] lg:text-[3.5rem] 2xl:text-[5.5rem] font-medium leading-[1.1] lg:leading-[1.02] tracking-normal md:tracking-normal text-white max-w-2xl lg:max-w-none !normal-case">
        ...
        <div className="lg:col-span-5 relative flex items-center justify-center mt-12 lg:mt-0">
          <div className="absolute w-[250px] h-[250px] bg-cyan-500/10 blur-[80px] rounded-full" />
          <motion.div
            animate={{ rotate: 360 }}
          ...
          >
            <Image
              ...
              height={700}
              priority
              className="relative z-[4] w-full h-auto object-contain drop-shadow-[0_20px_30px_rgba(0,0,0,0.5)]"
            />
          </motion.div>
        </div>
