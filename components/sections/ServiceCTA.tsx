...
export default function ConsultationCTA() {
  ...
  <motion.button
    whileTap={{ scale: 0.97 }}
    whileHover={{ y: -2 }}
    type="button" // 🎯 Submit se badal kar button kiya taake link behavior crash na ho
    className="group relative overflow-hidden h-14 w-full rounded-full bg-white border border-white/5 text-black font-black uppercase tracking-[0.25em] text-xs flex items-center justify-center gap-3 transition-all duration-500 active:scale-95 shadow-[0_10px_40px_rgba(37,99,235,0.15)] cursor-pointer"
  >
    {/* 🌊 Liquid Gradient Overlay Layer */}
