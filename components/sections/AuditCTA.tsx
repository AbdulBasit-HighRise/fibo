  ...
  return (
    ...
    <section className="relative w-full bg-[#111827] px-6 sm:px-8 py-6 md:py-8">
      ...
      <div className="relative z-10 max-w-7xl 2xl:max-w-[100rem] mx-auto">
        ...
        <div className="relative z-10 rounded-[2.2rem] md:rounded-[3rem] border border-white/10 bg-gradient-to-bl from-[#0971A6] via-[#054f7a] to-[#021526] px-6 py-10 sm:px-10 sm:py-12 lg:px-12 2xl:px-24 2xl:py-16 -translate-y-1 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8),0_20px_50px_rgba(6,182,212,0.15)] transition-all duration-500">
              ...
              >
                ...
                <div className="relative w-full">
                  ...
                  <input
                    ...
                    className="w-full h-[48px] 2xl:h-[54px] rounded-full bg-white border border-transparent pl-5 pr-5 text-xs sm:text-sm 2xl:text-base text-black placeholder:text-zinc-400 outline-none transition-all focus:ring-2 focus:ring-cyan-400/50 disabled:opacity-50"
                  />
                </div>
                ...
                <div className="w-full">
                  <button
                    type="submit"
                    disabled={status.loading}
                    className="group relative h-[48px] 2xl:h-[54px] px-4 md:px-6 2xl:px-8 rounded-full bg-white overflow-hidden transition-all duration-500 active:scale-95 shadow-xl whitespace-nowrap w-full disabled:opacity-50"
                  >
              ...
              <AnimatePresence mode="wait">
                {status.message && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -5 }}
                    className={`w-full p-2.5 rounded-xl text-center text-xs font-bold border sm:text-left sm:px-4 ${
                      status.success 
