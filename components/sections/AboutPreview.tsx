...
export default function AboutPreview() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-5 md:space-y-6 order-1 lg:order-2">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <span className="text-[10px] 2xl:text-sm uppercase tracking-[3px] text-blue-400 font-bold bg-blue-500/10 px-4 py-1.5 rounded-full border border-blue-500/20">
                Agency Insight
              </span>
            </motion.div>
  ...
  viewport={{ once: true }}
  /* Mobile: 5xl (bara aur wazay)
     Laptop: 7xl (kafi punchy)
     4K/Big Screens: [110px] (Custom massive size)
  */
  className="text-5xl md:text-7xl 2xl:text-[110px] font-black tracking-tighter text-white leading-[0.95]"
>
