...
export default function Process() {
 ...
 <div className="mb-12 md:mb-16 pt-0 text-center">
  ...
  <h3 className="!text-[2rem] sm:!text-4xl md:!text-4xl lg:!text-[2.5rem] xl:!text-[3rem]  font-black tracking-tighter leading-[1.1] lg:leading-[1] text-white normal-case">
    Our 
  {" "}
