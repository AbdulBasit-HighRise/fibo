...
<motion.h3 
  ...
  viewport={{ once: true }}
  className="mt-3 !text-[2rem] sm:!text-4xl md:!text-5xl lg:!text-[2.2rem] xl:!text-[2.5rem] 2xl:!text-[2.8rem] 3xl:!text-[3.5rem] font-black tracking-tighter leading-[1.1] lg:leading-none text-white pr-4 py-1"
>
  Our {" "}
