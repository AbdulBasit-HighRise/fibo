...
<section className="py-12 md:py-16 px-6 md:px-12 lg:px-20 relative border-t border-white/5">
  {/* 🎯 Width ko max-w-[110rem] kiya taake 2K/4K pr full space mile */}
  <div className="max-w-[110rem] w-full mx-auto">
    ...
    >
      {/* Introduction */}
      {/* 🎯 FIX: '!max-w-none' lagaya hai taake global css ka character-limit rule khatam ho jaye */}
      <p className="text-base md:text-lg lg:text-xl text-white leading-relaxed font-medium !max-w-none">
      ...
      <div className="space-y-4 w-full">
        ...
        <ul className="space-y-3 text-white text-sm md:text-base list-none border-l-2 border-blue-500/40 pl-5 font-normal opacity-95 w-full !max-w-none">
      ...
      <div className="mt-16 p-8 md:p-10 rounded-[2rem] bg-white/[0.02] border border-white/5 w-full !max-w-none">
        <h3 className="text-lg md:text-xl font-bold mb-2 text-white">Updates to This Policy</h3>
        <p className="text-white/80 text-sm leading-relaxed mb-8 !max-w-none">
