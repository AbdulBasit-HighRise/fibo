...
// // 1. Fonts optimization (Reduced layout shift)
...
//         {/* MASTER WRAPPER: 
//             Yahan 'max-w-[1920px] mx-auto' dala hai taake 4K screens par 
//             puri site center mein rahe aur ajeeb tarah se phailay nahi.
//         */}
//         <main className="relative z-10 min-h-screen max-w-[1920px] mx-auto w-full">
//           {children}
//         </main>
