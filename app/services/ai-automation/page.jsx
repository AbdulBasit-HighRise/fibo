...
export default function WebDevPage() {
  ...
  <div className="container-wide">
    ...
    {/* Full Sized Padded Content Wrapper - 🎯 FIXED: Spacing standardized for a cleaner aesthetic */}
    <div className="relative z-10 w-full mx-auto text-center lg:text-left px-6 py-24 md:py-32 lg:py-40 max-w-7xl lg:px-12 xl:px-16 2xl:max-w-[1500px] 3xl:max-w-[1800px]">
      <div className="max-w-5xl">
        ...
        {/* Main Typography Block - 🎯 FIXED: Resolved duplicates and fixed mobile overlapping */}
              ...
              <div className="space-y-6 md:space-y-6 order-1 lg:order-2">
                ...
                >
                  ...
                  <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl 3xl:text-2xl font-medium leading-relaxed max-w-xl 2xl:max-w-3xl mx-auto lg:mx-0 opacity-90">
                    Let’s be honest: scaling a business manually is exhausting. There are only so many hours in a day, and your team shouldn't spend them drowning in repetitive tasks. </p>
                  ...
                  <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl 3xl:text-2xl font-medium leading-relaxed max-w-xl 2xl:max-w-3xl mx-auto lg:mx-0 opacity-90 hidden md:block">
                    It isn't about replacing the human touch—it's about freeing up your time to focus on big-picture growth while your automated pipeline drives predictable, hands-free revenue.
                  </p>
            ...
            <div className="lg:col-span-6 space-y-6 md:space-y-8">
              ...
              >
                ...
                <div className="space-y-4 max-w-xl 2xl:max-w-3xl">
                  ...
                  <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl 3xl:text-2xl font-medium leading-relaxed mx-auto lg:mx-0 opacity-90">
                    With clear, honest communication and ongoing optimization, we ensure your tech stack is always working hard for you.
