...
export default function WebDevPage() {
  return (
    <main className="bg-[#030712] text-white selection:bg-blue-600 overflow-x-hidden">
      ...
      {/* 1. HERO SECTION - 4K Optimized */}
      <section className="relative w-full overflow-hidden min-h-[70vh] flex items-center">
        {/* 🕸️ Background Mesh - Using Next.js Image for Performance */}
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[800px] h-[400px] bg-blue-600/[0.08] blur-[120px] pointer-events-none" />
        ...
        <div className="relative z-10 max-w-7xl 2xl:max-w-[1600px] mx-auto px-6 pt-32 pb-16 md:pt-40 2xl:pt-56">
          <div className="max-w-5xl 2xl:max-w-7xl">
            ...
            <motion.h1 
              ...
              className="text-6xl sm:text-8xl md:text-[100px] 2xl:text-[150px] font-black tracking-tighter leading-[0.85] text-white mb-8"
            >
              Web <br />
