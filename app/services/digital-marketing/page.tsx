  ...
  const faqs = [
    {
      ...
      a: "SEO is a long-term game and usually shows results in 3-6 months, while PPC/Paid Ads can start driving targeted traffic and leads within the first few weeks of launching."
    },
    {
      q: "Which platforms should I focus on?",
      a: "It depends on your audience! We analyze your business niche to determine if you need LinkedIn for B2B, Instagram for visual brands, or Google Search for high-intent leads."
    },
    {
      q: "Do you provide transparent reporting?",
      a: "Yes. We believe in total transparency. You will receive regular reports tracking key metrics like CPA, conversion rates, and overall ROI so you always know where your budget is going."
    },
    {
      q: "Can you help me scale my existing ads?",
      a: "Absolutely. We specialize in optimizing underperforming campaigns and scaling winning ads by refining targeting, creative, and bidding strategies."
    },
    {
      q: "What makes your digital marketing approach different?",
      a: "We don't use 'one-size-fits-all' tactics. We combine deep technical SEO knowledge with creative ad performance to create a growth ecosystem unique to your business."
    },
    {
      q: "Do you handle content creation?",
      a: "Yes, we handle end-to-end content creation, including ad copy, landing page content, and social media posts, all optimized for high engagement."
    }
  ];
  const features = [
    {
      ...
      desc: "We boost your search engine rankings with strategic keyword research, technical audits, and content optimization to drive organic traffic.",
    },
    {
      icon: <Star className="w-5 h-5 2xl:w-8 2xl:h-8" />,
      title: "Targeted Paid Ads (PPC)",
      desc: "Maximize your ROI with high-converting ad campaigns on Google, Meta, and LinkedIn, tailored to reach your ideal audience precisely.",
    },
    {
      icon: <ShieldCheck className="w-5 h-5 2xl:w-8 2xl:h-8" />,
      title: "Social Media Strategy",
      desc: "We build your brand presence with engaging content and community management that fosters loyalty and increases brand awareness.",
    },
    {
      icon: <TrendingUp className="w-5 h-5 2xl:w-8 2xl:h-8" />,
      title: "Conversion Optimization",
      desc: "We analyze user behavior and optimize your funnels to ensure that more visitors turn into paying customers, scaling your business growth.",
    },
  ];
  const steps = [
    {
      ...
      desc: "We analyze your industry, competitors, and target audience to build a data-backed marketing roadmap for your business.",
      icon: <Search className="w-5 h-5 2xl:w-7 2xl:h-7" />
    },
    {
      id: "02",
      title: "Strategy Formulation",
      desc: "Our team crafts a custom multi-channel strategy, defining the right mix of SEO, PPC, and social media to hit your KPIs.",
      icon: <LayoutGrid className="w-5 h-5 2xl:w-7 2xl:h-7" />
    },
    {
      id: "03",
      title: "Execution & Creative",
      desc: "We launch your campaigns, creating high-impact content and ads that resonate with your audience and reflect your brand voice.",
      icon: <FileText className="w-5 h-5 2xl:w-7 2xl:h-7" />
    },
    {
      id: "04",
      title: "Monitoring & Testing",
      desc: "We run A/B tests and monitor real-time performance data to optimize campaigns for lower costs and higher conversions.",
      icon: <Globe2 className="w-5 h-5 2xl:w-7 2xl:h-7" />
    },
    {
      id: "05",
      title: "Scaling & Reporting",
      desc: "We scale what works, kill what doesn't, and provide transparent reports so you see exactly how your investment grows.",
          ...
          <div className="relative z-10 w-full mx-auto text-center lg:text-left px-6 pt-32 pb-16 md:pt-20 md:pb-24 lg:max-w-full lg:pt-40 lg:pb-28 lg:pl-40 2xl:mx-0 2xl:max-w-[1500px] 2xl:pt-48 2xl:pb-36 2xl:pl-80 3xl:mx-0 3xl:max-w-[1800px] 3xl:pt-60 3xl:pb-44 3xl:pl-72">
            <div className="max-w-5xl">
              ...
              <h1 className="text-[2rem] md:text-[3.2rem] lg:text-[3.8rem] 2xl:text-[5rem] font-black uppercase tracking-tighter leading-[1.1] lg:leading-[1.0] text-white mb-8">
                DATA-DRIVEN DIGITAL {" "} GROWTH & MARKETING.
              ...
              <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl 3xl:text-2xl font-medium leading-relaxed w-full max-w-3xl mx-auto lg:mx-0 opacity-80">
                We transform your online presence into a revenue-generating machine. From strategic SEO and high-converting paid ads to comprehensive social media growth, we deliver the insights and campaigns that scale your business.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6 md:space-y-6 order-1 lg:order-2">
              <div>
                <h2 className="text-[1.8rem] md:text-[2.5rem] lg:text-[2.5rem] 2xl:text-[3.2rem] font-black tracking-tighter leading-[1] text-white">
                  Maximize Your ROI with {" "}Our Marketing Strategy.
              ...
              >
                ...
                <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl 3xl:text-2xl font-medium leading-relaxed max-w-xl 2xl:max-w-3xl mx-auto lg:mx-0">
                  A great campaign is only the beginning; the real goal is to build a brand presence that captures attention and drives consistent results. Our marketing approach focuses on data-backed insights and creative precision to bring your business goals to life.
                </p>

                {/* Paragraph 2 */}
                <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl 3xl:text-2xl font-medium leading-relaxed max-w-xl 2xl:max-w-3xl mx-auto lg:mx-0">
                  By leveraging advanced analytics, multi-channel strategy, and hyper-targeted advertising, we streamline the path from a complex market challenge straight to a high-converting digital ecosystem that elevates your brand identity.
                </p>
                ...
                <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl 3xl:text-2xl font-medium leading-relaxed max-w-xl 2xl:max-w-3xl mx-auto lg:mx-0 hidden md:block">
                  We don’t just run ads; we optimize every touchpoint of your digital journey to ensure maximum ROI, creative depth, and sustained user engagement across all your marketing channels.
                </p>
              </motion.div>
            ...
            <div className="lg:col-span-6 space-y-6 md:space-y-8">
              ...
              >
                <h3 className="text-[2rem] md:text-[2.5rem] lg:text-[2.5rem] 2xl:text-[3.2rem] font-black tracking-tighter leading-[1.1] lg:leading-[1] mb-2 text-white">
                  Why Choose Our  Marketing Strategy?
                ...
                <div className="space-y-6 max-w-xl 2xl:max-w-3xl">
                  <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl font-medium leading-relaxed">
                    We don't just run ads; we architect <span className="font-black text-white">growth ecosystems</span> that scale your revenue. By blending data-driven insights with creative precision, we deliver campaigns that capture attention and convert visitors into loyal customers.
                  </p>
                  <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl font-medium leading-relaxed">
                    Our team works closely with you to map your unique business goals, ensuring every marketing channel is optimized for your brand's growth trajectory and long-term success.
                  </p>
                  <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl font-medium leading-relaxed">
                    From comprehensive SEO audits to high-converting performance marketing, we provide end-to-end digital solutions backed by rigorous analytics and strategic precision.
                  </p>
                  <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl font-medium leading-relaxed">
                    We combine industry-leading marketing tools with conversion-focused content to ensure every dollar of your budget works harder, giving your brand a distinct competitive advantage in the digital market.
                  </p>
                  <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl font-medium leading-relaxed">
                    Our studio operates with a result-first philosophy, ensuring transparent reporting and iterative optimization so that your marketing investment becomes a high-impact asset that drives your business forward.
                  </p>
                </div>
              </motion.div>
            </div>
