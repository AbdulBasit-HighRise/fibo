                  ...
                  <div className="space-y-6 max-w-xl 2xl:max-w-3xl">
                    <div className="space-y-6 max-w-xl 2xl:max-w-3xl">
                      <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl font-medium leading-relaxed">
                        We don't just add effects; we architect <span className="font-black text-white">cinematic experiences</span> that redefine visual storytelling. By blending technical mastery with artistic vision, we deliver seamless, high-fidelity VFX that stand the test of time.
                      </p>
                      <p className="text-white text-[16px] md:text-base lg:text-[17px] 2xl:text-xl font-medium leading-relaxed">
